...
function KeyboardButtonBlock({
  ...
  const { t } = useTranslation(RouteID.TelegramBotMenuConstructor, {
    keyPrefix: 'messageOffcanvas.keyboardBlock.keyboardButtonBlock',
  });

  const blockType = useMessageOffcanvasStore((state) => state.keyboardButtonBlock.type);
  const shouldShowURLInput = useMessageOffcanvasStore(
    (state) => state.keyboardButtonBlock.showURLInput,
  );
  const hideBlock = useMessageOffcanvasStore(
